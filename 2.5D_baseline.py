...
image_dir = "/data_vault/hexai/OAICartilage/Image"
...
def train_model(epochs=30, save_path="best_model.pth", log_csv_path="/home/feg48/2.5D_seg/training_log_baseline.csv"):
    best_iou = 0.0
    metrics_log = []
